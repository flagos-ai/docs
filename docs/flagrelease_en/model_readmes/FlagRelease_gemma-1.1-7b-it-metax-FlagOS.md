...
### Start the Server
```bash
VLLM_PLUGINS=fl vllm serve /data/gemma-1.1-7b-it-FlagOS --host 0.0.0.0 --port 8000 --served-model-name gemma-1.1-7b-it --tensor-parallel-size 1 --max-model-len 8192 --trust-remote-code
```
