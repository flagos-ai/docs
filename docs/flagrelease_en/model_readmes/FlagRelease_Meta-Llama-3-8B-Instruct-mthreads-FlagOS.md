...
```bash
docker pull harbor.baai.ac.cn/external-cooperation/meta_llama_3_8b_instruct-mthreads-tree_0.5.1-gems_5.0.2_vllm_0.13.0_plugin_0.1.0_cx_none_python_3.10.12_torch_2.7.1_pcp_musa_4.3.5_mtt_s5000_x86_64_driver_2.3.2:2607221440
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/Meta-Llama-3-8B-Instruct-mthreads-FlagOS --local_dir /data/vllm-plugin-fl/Meta-Llama-3-8B-Instruct-mthreads-FlagOS
```
...
docker run -itd \
  ...
  harbor.baai.ac.cn/external-cooperation/meta_llama_3_8b_instruct-mthreads-tree_0.5.1-gems_5.0.2_vllm_0.13.0_plugin_0.1.0_cx_none_python_3.10.12_torch_2.7.1_pcp_musa_4.3.5_mtt_s5000_x86_64_driver_2.3.2:2607221440
  sleep infinity
