...
# Evaluation Results
## Benchmark Result
| Metrics      | DeepSeek-V4-Flash-Nvidia-Origin | DeepSeek-V4-Flash-Metax-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA | 0.697                              | 0.6414                                   |
| Aime       | 0.7333                              | 0.7                                    |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-deepseek-flash:202604240026
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DeepSeek-V4-Flash-metax-FlagOS --local_dir /data/DeepSeek-V4-Flash-metax-FlagOS
```
...
docker run -d \
  ...
  -v /data:/data \
  -v /home:/home \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-deepseek-flash:202604240026 \
