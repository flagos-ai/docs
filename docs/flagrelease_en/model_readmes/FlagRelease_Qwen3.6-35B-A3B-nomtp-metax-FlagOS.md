...
```bash
docker pull flagrelease-public/flagrelease-metax-release-model_qwen3.6-35b-a3b-nomtp-tree_none-gems_4.2.0-vllm_0.13.0-cx_none-python_3.12.11-torch_musa-2.8.0-pcp_maca3.3.0.15-gpu_metax-arc_amd64-driver_2.2.9:202604152134
```
...
docker run -itd \
    ...
    --privileged \
     ...
     -v /data/:/data/ \
     flagrelease-public/flagrelease-metax-release-model_qwen3.6-35b-a3b-nomtp-tree_none-gems_4.2.0-vllm_0.13.0-cx_none-python_3.12.11-torch_musa-2.8.0-pcp_maca3.3.0.15-gpu_metax-arc_amd64-driver_2.2.9:202604152134 \
     /bin/bash
