...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-1B-Nvidia-Origin | MiniCPM5-1B-Ascend-FlagOS |
|--------------|--------------------------------------|--------------------------------------|
| hellaswag | 0.4742 | 0.425 |
| truthfulqa_mc1 | 0.3293 | 0.3378 |
| winogrande | 0.5484 | 0.5351 |
| commonsense_qa | 0.3473 | 0.3366 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-ascend-tree_none-gems_4.2.1rc0-vllm_ascend_0.13.0-plugin_0.1.0-cx_none-python_3.11.14-torch_npu_2.8.0.post2-pcp_cann8.5.0-gpu_ascend001-arc_arm64-driver_25.0:202605251626
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/MiniCPM5-1B-ascend-FlagOS --local_dir /data/MiniCPM5-1B
```
...
docker run -itd \
  ...
  harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-ascend-tree_none-gems_4.2.1rc0-vllm_ascend_0.13.0-plugin_0.1.0-cx_none-python_3.11.14-torch_npu_2.8.0.post2-pcp_cann8.5.0-gpu_ascend001-arc_arm64-driver_25.0:202605251626 \
  bash
