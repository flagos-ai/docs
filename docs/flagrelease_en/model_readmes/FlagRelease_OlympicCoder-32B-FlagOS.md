...
```bash
docker pull harbor.baai.ac.cn/flagrelease-project/olympiccoder-32b-nvidia003-gems5.4.0-tree0.6.0-cxnone-plugin0.2.0-vllm0.24.0-cp312-pt211-cu130-x64-570.158.01:202609111256-v3
```
...
### Start the Container
```bash
docker run -itd --name flagos --gpus=all --network=host -v /data:/data harbor.baai.ac.cn/flagrelease-project/olympiccoder-32b-nvidia003-gems5.4.0-tree0.6.0-cxnone-plugin0.2.0-vllm0.24.0-cp312-pt211-cu130-x64-570.158.01:202609111256-v3
```
### Start the Server
```bash
