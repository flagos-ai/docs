...
nohup vllm serve --model /data/Seed-OSS-36B-Instruct-iluvatar-FlagOS --served-model-name seed-oss-36b-flagos --port 8000 --tensor-parallel-size 2 --trust-remote-code --max-model-len 30000  >vllm.log 2>&1 &
```
