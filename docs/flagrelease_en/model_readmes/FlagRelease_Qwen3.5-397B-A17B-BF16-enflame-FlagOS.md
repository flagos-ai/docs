...
modelscope download --model FlagRelease/Qwen3.5-397B-A17B-BF16-enflame-FlagOS --local_dir /data/Qwen3.5-397B-A17B-BF16
```
...
vllm serve /data/Qwen3.5-397B-A17B-BF16 --tensor-parallel-size 8 --enforce-eager
```
