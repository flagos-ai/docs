...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/fathom-r1-14b-hygon001-gems5.4.0-tree0.6.0-cxnone-plugin0.2.0-vllm0.20.2-cp310-pt210-dtknone-x64-none:202607300317-v4
```
...
### Start the Server
```bash
VLLM_PLUGINS=fl vllm serve /data/Fathom-R1-14B-FlagOS --host 0.0.0.0 --port 8000 --served-model-name Fathom-R1-14B --tensor-parallel-size 1 --max-model-len 32768 --trust-remote-code --reasoning-parser deepseek_r1
```
