...
```bash
docker pull harbor.baai.ac.cn/flagrelease-project/qwen2.5-coder-7b-instruct-ascend001-gems5.3.4-tree0.6.0-cxnone-plugin0.2.0-vllm-ascend0.20.2-cp311-ptnpu210-cann90-a64-25.5.0:202608261757-v3-hotfix2
```
