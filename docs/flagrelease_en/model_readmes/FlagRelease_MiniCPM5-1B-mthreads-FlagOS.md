...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-1B-Nvidia-Origin | MiniCPM5-1B-Mthreads-FlagOS |
|--------------|--------------------------------------|--------------------------------------|
| hellaswag | 0.4742 | 0.475 |
| truthfulqa_mc1 | 0.3293 | 0.328 |
| winogrande | 0.5484 | 0.5517 |
| commonsense_qa | 0.3473 | 0.3497 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-mthreads-tree_0.5.1_mthreads3.6-gems_5.0.0-vllm_0.13.1.dev44_g3d4cc4bc7.d20260310.musa-plugin_0.1.0-cx_0.8.0-python_3.10.12-torch_2.7.1-pcp_musa4.3.5-drive:202605211552
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/MiniCPM5-1B-mthreads-FlagOS --local_dir /data/MiniCPM5-1B
```
...
docker run -itd \
  ...
  -v /data:/data \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-mthreads-tree_0.5.1_mthreads3.6-gems_5.0.0-vllm_0.13.1.dev44_g3d4cc4bc7.d20260310.musa-plugin_0.1.0-cx_0.8.0-python_3.10.12-torch_2.7.1-pcp_musa4.3.5-drive:202605211552 \
  bash
