...
# Evaluation Results
## Benchmark Result
| Metrics      | Model-X-Nvidia-Origin | Model-X-Ascend-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA_Diamond | -                              | -                                    |
| ERQA         | -                              | -                                    |
| Aime24       | -                              | -                                    |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-ascend-modelx:202604231720
```
...
docker run -d \
  ...
  -v /home:/home \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-ascend-modelx:202604231720 \
