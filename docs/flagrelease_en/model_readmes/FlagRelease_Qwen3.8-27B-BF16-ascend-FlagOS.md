...
# Evaluation Results
## Benchmark Result
| Metrics | Qwen3.8-278-Nvidia-Origin | Qwen3.8-278-Ascend-FlagOS |
|--------------|---------------------------|---------------------------|
| musr_murder_mysteries| 76.8                      | 76.31                     |
...
modelscope download --model FlagRelease/Qwen3.8-27B-BF16-ascend-FlagOS --local_dir /data/Qwen3.8-27B
```
