...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/qwen3.8-flash-next-hygon001-gems5.4.0-tree0.6.1-cxnone-plugin0.2.0-vllm0.26.1-cp310-pt210-dtk2604-x64-6.3.30-v1.4.1a:202608262000
```
...
docker run -d --name flagos \
  ...
  -e NCCL_IB_DISABLE=0 \
  harbor.baai.ac.cn/flagrelease-public/qwen3.8-flash-next-hygon001-gems5.4.0-tree0.6.1-cxnone-plugin0.2.0-vllm0.26.1-cp310-pt210-dtk2604-x64-6.3.30-v1.4.1a:202608262000 \
