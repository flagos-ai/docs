...
# Evaluation Results
## Benchmark Result
| Metrics      | aya-23-8B-metax-FlagOS-Origin | aya-23-8B-metax-FlagOS-FlagOS |
|--------------|-------------------------------|-------------------------------|
| GPQA_Diamond | 0 | 30.0 |
| ERQA | - | - |
| Aime24 | - | - |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-project/aya-23-8b-metax001-gems5.0.2-tree0.5.1-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt28-maca37-x64-3.3.12:202607230807-v3
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/aya-23-8B-metax-FlagOS --local_dir /data/aya-23-8B-FlagOS
```
...
### Start the Server
```bash
VLLM_PLUGINS=fl vllm serve /data/aya-23-8B-FlagOS --host 0.0.0.0 --port 8000 --served-model-name aya-23-8B --tensor-parallel-size 1 --max-model-len 8192 --trust-remote-code
```
