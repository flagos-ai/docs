...
|--------------|---------------------------------|---------------------------------|
| GPQA_Diamond | 91.41                           | 90.91                         |
|musr_murder_mysteries | 79.2| 79.2                              |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/qwen3.8-2.4t-a95b-nvidia004-gems5.3.3-tree0.5.0-cxnone-plugin0.3.0-vllm0.24.0-cp312-pt211-cu129-x64-580.126.20:202608100512
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/Qwen3.8-2.4T-A95B-INT8-nvidia-FlagOS --local_dir /data/Qwen3.8-2.4T-A95B-INT8
```

### Start the Container
```bash
set -euo pipefail
IMAGE=harbor.baai.ac.cn/flagrelease-public/qwen3.8-2.4t-a95b-nvidia004-gems5.3.3-tree0.5.0-cxnone-plugin0.3.0-vllm0.24.0-cp312-pt211-cu129-x64-580.126.20:202608100512
