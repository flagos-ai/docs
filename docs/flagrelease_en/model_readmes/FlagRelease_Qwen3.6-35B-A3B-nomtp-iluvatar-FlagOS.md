...
# Evaluation Results
## Benchmark Result
|Metrics|Qwen3.6-35B-A3B-nomtp-Nvidia-Origin|Qwen3.6-35B-A3B-nomtp-Iluvatar-FlagOS|
|-------|---------------|---------------|
|GPQA_Diamond |0.8283 |0.8367|
|ERQA  | 0.5875  | 0.5616 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/qwen3.6-35b-a3b-nomtp-iluvatar-gems_4.2.1rc0-vllm_0.13.0-vllm_plugin_fl_0.0.0:2604161551
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/FlagRelease/Qwen3.6-35B-A3B-nomtp-iluvatar-FlagOS --local_dir /data/Qwen3.6-35B-A3B-nomtp
```
...
docker run --shm-size="32g" -itd \
  ...
  --name flagos harbor.baai.ac.cn/flagrelease-public/qwen3.6-35b-a3b-nomtp-iluvatar-gems_4.2.1rc0-vllm_0.13.0-vllm_plugin_fl_0.0.0:2604161551 /bin/bash
...
VLLM_USE_MODELSCOPE=true vllm serve /data/Qwen3.6-35B-A3B-nomtp/ -tp 8 --served-model-name qwen36 --enforce-eager --port 8000  --max-model-len 262144 
