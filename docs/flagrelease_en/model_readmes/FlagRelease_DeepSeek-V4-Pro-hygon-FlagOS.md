...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hygon-deepseek-v4-pro:202604250050
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DeepSeek-V4-Pro-hygon-FlagOS --local_dir /data/DeepSeek-V4-Pro-hygon-FlagOS
```
...
docker run \
  ...
  -itd \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-hygon-deepseek-v4-pro:202604250050
