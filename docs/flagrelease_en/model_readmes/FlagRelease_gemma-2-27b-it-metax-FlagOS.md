...
# Evaluation Results
## Benchmark Result
| Metrics      | gemma-2-27b-it-metax-FlagOS-Origin | gemma-2-27b-it-metax-FlagOS-FlagOS |
|--------------|------------------------------------|------------------------------------|
| GPQA_Diamond | 0 | 46.0 |
| ERQA | - | - |
| Aime24 | - | - |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/gemma-2-27b-it-metax001-gems5.0.2-tree0.5.1-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt28-maca37-x64-3.3.12:202608010938-v2
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/gemma-2-27b-it-metax-FlagOS --local_dir /data/gemma-2-27b-it-FlagOS
```
...
### Start the Server
```bash
vllm serve /data/gemma-2-27b-it-FlagOS --host 0.0.0.0 --port 8000 --served-model-name gemma-2-27b-it --tensor-parallel-size 2 --max-model-len 8192 --trust-remote-code
```
