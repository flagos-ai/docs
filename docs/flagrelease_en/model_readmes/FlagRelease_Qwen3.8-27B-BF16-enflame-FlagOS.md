...
# Evaluation Results
## Benchmark Result
| Metrics      | Qwen3.8-27B-Nvidia-Origin | Qwen3.8-27B-enflame-FlagOS |
|-------|---------------------------|----------------------------|
| GPQA_Diamond | 90.4                      | 86.36                      |
|musr_murder_mysteries | 76.8                      | 76.4                       |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/qwen3.8-27b-enflame002-gems5.4.0-treenone-triton3.6.0-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt211-x64-1.9.29:202608142003
...
modelscope download --model FlagRelease/Qwen3.8-27B-BF16-enflame-FlagOS --local_dir /data/Qwen3.8-27B
```
...
docker run -d \
    ...
    -v /data:/data \
    --name flagos \
    harbor.baai.ac.cn/flagrelease-public/qwen3.8-27b-enflame002-gems5.4.0-treenone-triton3.6.0-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt211-x64-1.9.29:202608142003 \
    bash
...
export TOPS_VISIBLE_DEVICES=4,5,6,7
export TORCH_GCU_ENABLE_INT64_AND_UINT64=1
export ENABLE_I64_CHECK=0
export TORCHGCU_INDUCTOR_ENABLE=1
export PYTHONPATH=/usr/lib/python3/dist-packages:${PYTHONPATH:-}
export VLLM_FL_FLAGOS_BLACKLIST=layer_norm,native_layer_norm,constant_pad_nd,_scaled_dot_product_flash_attention,chunk_gated_delta_rule_fwd,fused_recurrent_gated_delta_rule_fwd,index,index_put_,index_put,_index_put_impl_,linear,pow_tensor_scalar,pow_tensor_scalar_,zeros,mean_dim,silu,silu_,exponential_
...
vllm serve /data/Qwen3.8-27B \
        ...
        --compilation-config '{"mode":0,"cudagraph_mode":"FULL_DECODE_ONLY","cudagraph_capture_sizes":[1,2,4,8,16],"cudagraph_num_of_warmups":1}'
```
## Service Invocation
...
# License
The model weights are sourced from Qwen/Qwen3.8-27B and open-sourced under the Apache 2.0 license
