...
modelscope download --model FlagRelease/Kimi-Linear-48B-A3B-Instruct-methreads-FlagOS --local_dir /data/Kimi-Linear-48B-A3B-Instruct-methreads-FlagOS
```
...
nohup vllm serve /data/Kimi-Linear-48B-A3B-Instruct-mthreads-FlagOS \
