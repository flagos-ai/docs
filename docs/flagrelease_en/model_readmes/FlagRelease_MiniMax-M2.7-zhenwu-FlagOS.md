...
# Evaluation Results
## Benchmark Result
|Metrics|MiniMax-M2.7-Nvidia-Origin|MiniMax-M2.7-Zhenwu-FlagOS|
|-------|---------------|---------------|
|Gpqa_Diamond |0.7071 |0.6566|
|Aime24  | 0.9  | 0.9333|
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-zhenwu-minimax:202604120848
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/MiniMax-M2.7-zhenwu-FlagOS --local_dir /data/MiniMax-M2.7
```

### Start the Server
```bash
vllm serve /data/MiniMax-M2.7 --served-model-name minimax-m2.7 --host 0.0.0.0 --port 8000 --trust-remote-code --tensor-parallel-size 8 --gpu-memory-utilization 0.95  --enable-auto-tool-choice --tool-call-parser minimax_m2 --reasoning-parser minimax_m2_append_think
