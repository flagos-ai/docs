...
docker run \
  ...
  -v /data:/data \
  harbor.baai.ac.cn/flagrelease-public/xing4.0-29b-a4b-tsingmicro001-gems5.4.0-treenone-cx0.1.0-plugin0.0.0-vllm0.24.0-sglangnone-sglangflnone-cp310-pt211-raisa1.4.0-x64-v260629145101:202609181022 \
  /bin/bash
```
### Start the Server
```bash
cd /home/env
bash Xing4.0_server.sh
bash dp_route.sh
```
...
### Invocation Script
```bash
curl -X POST "http://10.1.15.137:8087/v1/completions" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "/mnt/nvme_data/models/Xing4.0-29B-A4B/",
    "prompt": "中国的首都是哪里？",
    "max_tokens": 10,
    "temperature": 0.0
  }'
