...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-deepseek-pro:202604251011
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DeepSeek-V4-Pro-metax-FlagOS --local_dir /data/DeepSeek-V4-Pro-metax-FlagOS
```
...
docker run -d \
  ...
  -v /home:/home \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-metax-deepseek-pro:202604251011 \
...
### Invocation Script
```bash
# code location: /root/code_dv_v3/r
bash /root/cluster-deploy/code_dv_v3/model_run.sh --nodes 10.0.0.1 10.0.0.2 10.0.0.3 10.0.0.4 10.0.0.5 10.0.0.6 10.0.0.7 10.0.0.8
```
