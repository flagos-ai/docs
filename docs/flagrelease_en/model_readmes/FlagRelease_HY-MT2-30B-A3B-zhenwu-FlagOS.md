...
# Evaluation Results
## Benchmark Result
| Metrics(chrf)        | HY-MT2-30B-A3B-Nvidia-Origin | HY-MT2-30B-A3B-Zhenwu-FlagOS |
|--------------|------------------------------|------------------------------|
| flores_ca | 57.79 | 57.558 |
| wmt16 | 60.92 | 60.7098 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-30b-a3b-zhenwu-tree_none-gems_5.0.1rc0-vllm_0.13.1.dev0_g72506c983.d20260218-plugin_0.1.0_vllm0.13.0-cx_none-python_3.12.3-torch_2.9.0-pcp_hggc13.0-gpu_pp001-arc_amd64-driver_1.3.2-d7f5a2:202605191318
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/HY-MT2-30B-A3B-zhenwu-FlagOS --local_dir /data/HY-MT2-30B-A3B
```
### Start the Server
```bash
vllm serve /data/HY-MT2-30B-A3B \
--trust-remote-code \
--dtype bfloat16 \
--enforce-eager \
--port 8000 \
