...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/qwen3.8-flash-ppu001-gems5.0.0-tree0.6.1-cxnone-plugin0.2.0-vllm0.24.0-cp312-pt210-x64:202608261449
```
...
sudo docker run --privileged -dit \
    ...
    -w /mnt/ \
    --name flagos \
    harbor.baai.ac.cn/flagrelease-public/qwen3.8-flash-ppu001-gems5.0.0-tree0.6.1-cxnone-plugin0.2.0-vllm0.24.0-cp312-pt210-x64:202608261449
docker exec -it flagos /bin/bash
```
### Start the Server
```bash
export VLLM_EXECUTE_MODEL_TIMEOUT_SECONDS=6000
nohup vllm serve /mnt/cpfs/models/Qwen3.8-Flash-Next/ \
--port 8020 \
--trust-remote-code \
