...
| ------------------- | ------------------------------------------- | ------------------------------------------- |
| musr_generative     | 0.3320                                      | 0.3429                                      |
| mmlu_pro            | 0.1747                                      | 0.1734                                      |
| aime                | 0                                           | 0                                           |
| livebench_new       | 0.1261                                      | 0.1308                                      |
| gpqa_generative_cot | 0.0866                                      | 0.0901                                      |
...
```bash
docker pull harbor.baai.ac.cn/external-cooperation/deepseek-r1-distill-qwen-1.5b-nvidia-tree_0.5.0-gems_0.5.1rc0_vllm_0.13.0-plugin_v0.1.0_vllm0.13.0-cx_none-python_3.12.3-torch_2.9.0.dev20250804_cu128-pcp_cuda12.9-gpu_nvidia003-arc_amd64-driver_570.124.06:2607211543 
```
...
```bash
docker run -itd  --name=flagos  --gpus=all  --network=host  -v /data:/data  harbor.baai.ac.cn/external-cooperation/deepseek-r1-distill-qwen-1.5b-nvidia-tree_0.5.0-gems_0.5.1rc0_vllm_0.13.0-plugin_v0.1.0_vllm0.13.0-cx_none-python_3.12.3-torch_2.9.0.dev20250804_cu128-pcp_cuda12.9-gpu_nvidia003-arc_amd64-driver_570.124.06:2607211543  sleep infinity
