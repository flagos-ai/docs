...
# Evaluation Results
## Benchmark Result
| Metrics      | DeepSeek-V4-Flash-Nvidia-Origin | DeepSeek-V4-Flash-Zhenwu-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA | 0.697                              | 0.7172                                   |
| Aime       | 0.7333                              | 0.7                                    |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-zhenwu-deepseek:202604252026
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DeepSeek-V4-Flash-zhenwu-FlagOS --local_dir /data/DeepSeek-V4-Flash-zhenwu-FlagOS
```
