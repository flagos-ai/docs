...
# Evaluation Results
## Benchmark Result
| Metrics      | DeepSeek-V4-Flash-Nvidia-Origin | DeepSeek-V4-Flash-Kunlunxin-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA | 0.697                              | 0.6111                                   |
| Aime       | 0.7333                              | 0.6667                                    |
...
modelscope download --model FlagRelease/DeepSeek-V4-Flash-kunlunxin-FlagOS --local_dir /data/DeepSeek-V4-Flash-kunlunxin-FlagOS
```

### Start the Container
```bash
docker run -dti --name flagos \
