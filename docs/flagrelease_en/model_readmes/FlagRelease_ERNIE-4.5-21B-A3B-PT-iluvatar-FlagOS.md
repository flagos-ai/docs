...
# Evaluation Results
## Benchmark Result
| Metrics      | ERNIE-4.5-21B-A3B-PT-Nvidia-Origin | ERNIE-4.5-21B-A3B-PT-Iluvatar-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| aime         | 0.3667                         | 0.3667                                  |
| gpqa_generative_cot         | 0.5713                         | 0.5763                               |
| musr_generative         | 0.6296                         | 0.6310                               |
| mmlu_pro     | 0.6644                         | 0.6585                               |
| livebench_new    | 0.5563                         | 0.5435                               |
...
```bash
docker pull harbor.baai.ac.cn/external-cooperation/ernie-4.5-21b-a3b-pt-iluvatar-tree_0.5.1_iluvatar3.1-gems_5.0.2-vllm_0.13.0_cu102-plugin_0.1.1-cx_none-python_3.10.18-torch_2.7.1_corex.4.4.0-pcp_corex-4.4.0-gpu_biv150-arc_x86_64-driver_4.4.0:2606181533
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/ERNIE-4.5-21B-A3B-PT-iluvatar-FlagOS --local_dir /data/models/ERNIE-4.5-21B-A3B-PT-iluvatar-FlagOS
```
...
docker run --name flagos -itd \
  ...
  --net=host \
  -w /workspace \
  harbor.baai.ac.cn/external-cooperation/ernie-4.5-21b-a3b-pt-iluvatar-tree_0.5.1_iluvatar3.1-gems_5.0.2-vllm_0.13.0_cu102-plugin_0.1.1-cx_none-python_3.10.18-torch_2.7.1_corex.4.4.0-pcp_corex-4.4.0-gpu_biv150-arc_x86_64-driver_4.4.0:2606181533 \
  sleep infinity
...
nohup env VLLM_PLUGINS=fl \
        USE_FLAGGEMS=1 \
        VLLM_FL_FLAGOS_BLACKLIST=mul,cos,copy_,to_copy,mm,cat,sub \
        vllm serve --model /data/models/ERNIE-4.5-21B-A3B-PT-iluvatar-FlagOS \
