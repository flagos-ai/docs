...
# Evaluation Results
## Benchmark Result
| Metrics(chrf)         | HY-MT2-7B-Nvidia-Origin | HY-MT2-7B-Nvidia-FlagOS |
|--------------|-------------------------|-------------------------|
| flores_ca | 52.46 | 52.46 |
| wmt16 | 60.21 | 60.18 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-7b-nvidia-tree_0.5.0_3.5-gems_5.0.1rc0-vllm_0.20.2-plugin_0.0.0-cx_none-python_3.12.3-torch_2.11.0-pcp_cuda13.2-gpu_nvidia003-arc_amd64-driver_570.158.01:202605191822
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/HY-MT2-7B-nvidia-FlagOS --local_dir /data/HY-MT2-7B-FlagOS
```
...
### Start the Server
```bash
vllm serve /data/HY-MT2-7B-FlagOS \
