...
### Start the Server
```bash
export VLLM_PLUGINS=fl export TRITON_ALL_BLOCKS_PARALLEL=1 export USE_FLAGGEMS=1 export VLLM_FL_FLAGOS_WHITELIST=zero_,arange,sin,lt_scalar,bitwise_and_tensor,lt,neg_,index nohup vllm serve /data/Phi-3.5-MoE-instruct-ascend-FlagOS \ --served-model-name phi-3.5-moe-instruct-ascend-flagos \ --host 0.0.0.0 \ --port 8230 \ --trust-remote-code \ --enforce-eager \ --tensor-parallel-size 2 \ --gpu-memory-utilization 0.9 \ --max-model-len 50000 \ > Phi-3.5-MoE.log 2>&1 &
```
