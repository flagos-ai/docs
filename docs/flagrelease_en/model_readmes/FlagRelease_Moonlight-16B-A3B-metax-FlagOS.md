...
docker run -itd \
  ...
  --network host \
  -v /data/Moonlight-16B-A3B-metax-FlagOS:/data/Moonlight-16B-A3B-metax-FlagOS \
...
CUDA_VISIBLE_DEVICES=1,2 MACA_VISIBLE_DEVICES=1,2 nohup python3 -m vllm.entrypoints.openai.api_server \
    --model /data/Moonlight-16B-A3B-metax-FlagOS \
