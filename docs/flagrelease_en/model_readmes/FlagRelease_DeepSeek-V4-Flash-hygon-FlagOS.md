...
# Evaluation Results
## Benchmark Result
| Metrics      | DeepSeek-V4-Flash-Nvidia-Origin | DeepSeek-V4-Flash-Hygon-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA | 0.697                              | 0.702                                  |
| Aime       | 0.7333                              | 0.7                                    |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hygon-deepseek-v4-flash:202604242039
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DeepSeek-V4-Flash-hygon-FlagOS --local_dir /data/DeepSeek-V4-Flash-hygon-FlagOS
```
...
docker run \
  ...
  -itd \
  harbor.baai.ac.cn/flagrelease-public/flagrelease-hygon-deepseek-v4-flash:202604242039
