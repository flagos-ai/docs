...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/dasd-4b-thinking-iluvatar001-gems5.0.0-tree0.6.0-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt210-ixml44-x64-4.5.0:202607250202-v2
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/DASD-4B-Thinking-iluvatar-FlagOS --local_dir /data/DASD-4B-Thinking-FlagOS
```

### Start the Container
```bash
docker run -itd --name flagos --privileged --network=host -v /dev:/dev -v /lib/modules:/lib/modules -v /data:/data harbor.baai.ac.cn/flagrelease-public/dasd-4b-thinking-iluvatar001-gems5.0.0-tree0.6.0-cxnone-plugin0.2.0-vllm0.20.2-cp312-pt210-ixml44-x64-4.5.0:202607250202-v2
```
### Start the Server
```bash
VLLM_PLUGINS=fl vllm serve /data/DASD-4B-Thinking-FlagOS --host 0.0.0.0 --port 8000 --served-model-name DASD-4B-Thinking --tensor-parallel-size 1 --max-model-len 32768 --trust-remote-code --enforce-eager
```
