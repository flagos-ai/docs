...
|Communication compatibility|FlagCX collective communication correctness|100%|
|Framework compatibility|Basic FlagScale training and inference workflow|100%|
...
|Communication encryption|FlagCX communication-link encryption validation|Passed|
...
|Cross-vendor communication|FlagCX cross-vendor testing|Correctness 100%|
